...
if(isset($_POST['save']))
{
	...
	$sql = "INSERT INTO tb_museum (nama, alamat, didirikan, harga, jadwal, deskripsi, username, longitude, latitude)
	VALUES ('$nama', '$alamat', '$didirikan', '$harga', '$jadwal', '$deskripsi', 'admin', '$longitude', '$latitude')";
